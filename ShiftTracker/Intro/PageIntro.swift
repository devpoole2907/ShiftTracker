...
var pageIntros: [PageIntro] = [
    ...
    .init(introAssetImage: "LiveEarnings", title: "Live earnings", subTitle: "Track earnings in real-time. Our Lock Screen widgets offer a quick glance at your current earnings."),
