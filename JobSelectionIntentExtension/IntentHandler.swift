...
class IntentHandler: INExtension, SelectJobHandling {
    let persistenceController = PersistenceController.shared

    func provideJobIDOptionsCollection(for intent: SelectJob, searchTerm: String?, with completion: @escaping (INObjectCollection<NSString>?, Error?) -> Void) {
